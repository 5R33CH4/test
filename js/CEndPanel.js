function CEndPanel(){
    ...
    this._init = function(){
        ...
        _oSpotLogo = new CGfxButton(150, 100, oSprite,_oPanelContainer);
        _oSpotLogo.addEventListener(ON_MOUSE_UP, this._onSpotLogoBut, this);
        _oSpotLogo.pulseAnimation();
        ...
        _oYouTubeLogo = new CGfxButton(-150, 100, oSprite,_oPanelContainer);
        _oYouTubeLogo.addEventListener(ON_MOUSE_UP, this._onYouTubeLogoBut, this);
        _oYouTubeLogo.pulseAnimation();
