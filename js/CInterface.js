function CInterface(){
    ...
    this._init = function(){                
        ...
        ////////SET BESTTIME
        _oBestTime = new CTimer(110, 50, _oTimeContainer, 30, "#ffffff", "best_time", "#000000");
        
        ////////SET CURTIME
        _oCurTime = new CTimer(110, 120, _oTimeContainer, 30, "#ffffff", "timer", "#000000");

        ////////SET TIME COUNTER
        _pStartPosTimer = {x: CANVAS_WIDTH/2, y: 60};
        _oTimer = new CTimer(_pStartPosTimer.x, _pStartPosTimer.y, s_oStage, 100, "#E777CB", null,"#ffffff");
        ...
        _oCountdownTextStroke = new createjs.Text(""," 300px "+PRIMARY_FONT, "#ffffff");
        ...
        _oCountdownText = new createjs.Text(""," 300px "+PRIMARY_FONT, "rgba(231,119,203,1)");
