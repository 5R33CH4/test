...
LEVEL_INFO[0] = {   "time":65000, "num_cars":10, 
                    "terrain":{"roadbounds":2, "num_lanes":3, "adherence":1, "max_inertia":0.03 , "color": {
                                                                                                    "light":  { road: '#080E3D', grass: "#482985", rumble: '#F3CCFC', lane: '#F3CCFC'  },
                                                                                                    "dark":   { road: '#010733', grass: "#381d6d", rumble: '#F3CCFC'                   }
                                                                                                } 
                                                            }
                };
AMBIENT_INFO[0] = [
...
LEVEL_INFO[1] = {   "time":70000, "num_cars":15, 
                    "terrain":{"roadbounds":2, "num_lanes":3, "adherence":1, "max_inertia":0.03 , "color": {
                                                                                                    "light":  { road: '#080E3D', grass: "#080E3D", rumble: '#F3CCFC', lane: '#F3CCFC'  },
                                                                                                    "dark":   { road: '#010733', grass: "#010733", rumble: '#DAAFE4'                   }
                                                                                                } 
                                                            }
                };
AMBIENT_INFO[1] = [
...
LEVEL_INFO[3] = {   "time":73000, "num_cars":20, 
                    "terrain":{"roadbounds":2, "num_lanes":2, "adherence":0.5, "max_inertia":0 , "color": {
                                                                                                    "light":  { road: '#080E3D', grass: "#41239B", rumble: '#F3CCFC', lane: '#F3CCFC'  },
                                                                                                    "dark":   { road: '#010733', grass: "#381E86", rumble: '#F3CCFC'                   }
                                                                                                } 
                                                            }
                };
AMBIENT_INFO[3] = [
