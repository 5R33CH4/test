function CMain(oData){
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_play","./sprites/insertcoin.svg");
        s_oSpriteLibrary.addSprite("msg_box","./sprites/msg_box.png");
        s_oSpriteLibrary.addSprite("keys","./sprites/keys.svg");
        s_oSpriteLibrary.addSprite("star","./sprites/star.svg");
        s_oSpriteLibrary.addSprite("best_time","./sprites/best_time.svg");
        s_oSpriteLibrary.addSprite("timer","./sprites/timer.svg");
        s_oSpriteLibrary.addSprite("but_home","./sprites/but_home.svg");
        s_oSpriteLibrary.addSprite("logo_menu","./sprites/logo_menu.svg");
        s_oSpriteLibrary.addSprite("band_logo","./sprites/band_logo.svg");
        s_oSpriteLibrary.addSprite("bg_select","./sprites/bg_select.jpg");
        s_oSpriteLibrary.addSprite("but_credits","./sprites/but_credits.svg");
        s_oSpriteLibrary.addSprite("ctl_logo","./sprites/ctl_logo.svg");
        s_oSpriteLibrary.addSprite("spotify_logo","./sprites/spotify_logo.svg");
        s_oSpriteLibrary.addSprite("youtube_logo","./sprites/youtube_logo.svg");
        ...
        s_oSpriteLibrary.addSprite("but_delete_saving","./sprites/but_delete_saving.svg");
        
        s_oSpriteLibrary.addSprite("bg_menu","./sprites/bg_menu.jpg"); 
        s_oSpriteLibrary.addSprite("but_level","./sprites/but_level.svg");
        ...
        s_oSpriteLibrary.addSprite("w0_bg0","./sprites/backgrounds/world_0/bg0.jpg");
        s_oSpriteLibrary.addSprite("w0_bg1","./sprites/backgrounds/world_0/bg1.png");
        s_oSpriteLibrary.addSprite("w1_bg0","./sprites/backgrounds/world_1/bg0.jpg");
        s_oSpriteLibrary.addSprite("w1_bg1","./sprites/backgrounds/world_1/bg1.png");
        s_oSpriteLibrary.addSprite("w2_bg0","./sprites/backgrounds/world_2/bg0.jpg");
        s_oSpriteLibrary.addSprite("w2_bg1","./sprites/backgrounds/world_2/bg1.png");
        
        s_oSpriteLibrary.addSprite("key_up","./sprites/key_up.svg");
        s_oSpriteLibrary.addSprite("key_down","./sprites/key_down.svg");
        s_oSpriteLibrary.addSprite("key_left","./sprites/key_left.svg");
        s_oSpriteLibrary.addSprite("key_right","./sprites/key_right.svg");
        
        s_oSpriteLibrary.addSprite("but_exit","./sprites/but_exit.svg");
        s_oSpriteLibrary.addSprite("audio_icon","./sprites/sound_on_off.svg");
        s_oSpriteLibrary.addSprite("but_restart","./sprites/but_restart.svg");
        s_oSpriteLibrary.addSprite("but_next","./sprites/but_next.svg");
        s_oSpriteLibrary.addSprite("time_panel","./sprites/time_panel.png");
        s_oSpriteLibrary.addSprite("tachometer","./sprites/tachometer.svg");
        s_oSpriteLibrary.addSprite("baloon_mc","./sprites/baloon_mc.svg");
