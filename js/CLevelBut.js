function CLevelBut(iXPos,iYPos,oSprite, bActive, iLevel, oParentContainer){
    ...
    this.addScore = function(iScore){
        var oScoreStroke = new createjs.Text(formatTime(iScore)," 25px "+PRIMARY_FONT, "#000000");
        ...
        var oScore = new createjs.Text(formatTime(iScore)," 25px "+PRIMARY_FONT, "#ffffff");
    ...
    this.addLevelText = function(iLevel){
        ...
        _oLevel = new createjs.Text(iLevel," 80px "+PRIMARY_FONT, "#FFC3F0");
        _oLevel.y = 2;
